 ...
 -->
	...
	<body id="login">
		...
		<header id="header">
			...
			<span id="extr-page-header-space"> <span class="hidden-mobile hidden-xs">Already registered?</span> <a href="${cxt}/login" class="btn btn-danger">Sign In</a> </span>
				...
				<div class="row">
					...
					<div class="col-xs-12 col-sm-12 col-md-5 col-lg-5">
						<div class="well no-padding">
							...
							<form action="${cxt}/static/smart/php/demo-register.php" id="smart-form-register" class="smart-form client-form">
								<header>
