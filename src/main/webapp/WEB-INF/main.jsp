...
<html lang="en-us">	
 ...
 -->
	...
	<body class="smart-style-0">
		...
		<header id="header">
				...
				<div class="ajax-dropdown">
					...
					<div class="btn-group btn-group-justified" data-toggle="buttons">
						<label class="btn btn-default">
							<input type="radio" name="activity" id="${cxt}/static/smart/ajax/notify/mail.html">
							Msgs (14) </label>
						<label class="btn btn-default">
							<input type="radio" name="activity" id="${cxt}/static/smart/ajax/notify/notifications.html">
							notify (3) </label>
						<label class="btn btn-default">
							<input type="radio" name="activity" id="${cxt}/static/smart/ajax/notify/tasks.html">
							Tasks (4) </label>
					</div>
			...
			<div class="pull-right">
				...
				<ul id="mobile-profile-img" class="header-dropdown-list hidden-xs padding-5">
					<li class="">
						<a href="#" class="dropdown-toggle no-margin userdropdown" data-toggle="dropdown"> 
							<img src="${cxt}/static/smart/img/avatars/sunny.png" alt="John Doe" class="online" />  
						</a>
						<ul class="dropdown-menu pull-right">
							...
							<li class="divider"></li>
							<li>
								<a href="${cxt}/login" class="padding-10 padding-top-5 padding-bottom-5" data-action="userLogout"><i class="fa fa-sign-out fa-lg"></i> <strong><u>L</u>ogout</strong></a>
							</li>
						</ul>
					</li>
				</ul>
				...
				<div id="logout" class="btn-header transparent pull-right">
					<span> <a href="${cxt}/login" title="Sign Out" data-action="userLogout" data-logout-msg="You can improve your security further after logging out by closing this opened browser"><i class="fa fa-sign-out"></i></a> </span>
				</div>
				<!-- end logout button -->
				...
				<ul class="header-dropdown-list hidden-xs">
					<li>
						<a href="#" class="dropdown-toggle" data-toggle="dropdown"> <img src="${cxt}/static/smart/img/blank.gif" class="flag flag-us" alt="United States"> <span> US</span> <i class="fa fa-angle-down"></i> </a>
						<ul class="dropdown-menu pull-right">
							<li class="active">
								<a href="javascript:void(0);"><img src="${cxt}/static/smart/img/blank.gif" class="flag flag-us" alt="United States"> English (US)</a>
							</li>
							<li>
								<a href="javascript:void(0);"><img src="${cxt}/static/smart/img/blank.gif" class="flag flag-fr" alt="France"> Français</a>
							</li>
							<li>
								<a href="javascript:void(0);"><img src="${cxt}/static/smart/img/blank.gif" class="flag flag-es" alt="Spanish"> Español</a>
							</li>
							<li>
								<a href="javascript:void(0);"><img src="${cxt}/static/smart/img/blank.gif" class="flag flag-de" alt="German"> Deutsch</a>
							</li>
							<li>
								<a href="javascript:void(0);"><img src="${cxt}/static/smart/img/blank.gif" class="flag flag-jp" alt="Japan"> 日本語</a>
							</li>
							<li>
								<a href="javascript:void(0);"><img src="${cxt}/static/smart/img/blank.gif" class="flag flag-cn" alt="China"> 中文</a>
							</li>	
							<li>
								<a href="javascript:void(0);"><img src="${cxt}/static/smart/img/blank.gif" class="flag flag-it" alt="Italy"> Italiano</a>
							</li>	
							<li>
								<a href="javascript:void(0);"><img src="${cxt}/static/smart/img/blank.gif" class="flag flag-pt" alt="Portugal"> Portugal</a>
							</li>
							<li>
								<a href="javascript:void(0);"><img src="${cxt}/static/smart/img/blank.gif" class="flag flag-ru" alt="Russia"> Русский язык</a>
							</li>
							<li>
								<a href="javascript:void(0);"><img src="${cxt}/static/smart/img/blank.gif" class="flag flag-kr" alt="Korea"> 한국어</a>
							</li>						
		...
		<aside id="left-panel">
			...
			<div class="login-info">
				<span> <!-- User image size is adjusted inside CSS, it should stay as is --> 
					...
					<a href="javascript:void(0);" id="show-shortcut" data-action="toggleShortcut">
						<img src="${cxt}/static/smart/img/avatars/sunny.png" alt="me" class="online" /> 
						<span>
							john.doe 
						</span>
			...
			<nav>
				...
				<ul>
					<!-- 自定义添加 -->
					<li class="">
						<a href="#" title="系统管理"><i class="fa fa-lg fa-fw fa-home"></i> <span class="menu-item-parent">系统管理</span></a>
						<ul>
							<li class="">
								<a href="system/sysuser/show-list" title="用户管理"><span class="menu-item-parent">用户管理</span></a>
							</li>
						</ul>	
					</li>
					<!-- ############################ -->
		...
		<script src="${cxt}/static/smart/js/plugin/jquery-touch/jquery.ui.touch-punch.min.js"></script> 

		<!-- BOOTSTRAP JS -->
		<script src="${cxt}/static/smart/js/bootstrap/bootstrap.min.js"></script>

		<!-- CUSTOM NOTIFICATION -->
		<script src="${cxt}/static/smart/js/notification/SmartNotification.min.js"></script>

		<!-- JARVIS WIDGETS -->
		<script src="${cxt}/static/smart/js/smartwidgets/jarvis.widget.min.js"></script>

		<!-- EASY PIE CHARTS -->
		<script src="${cxt}/static/smart/js/plugin/easy-pie-chart/jquery.easy-pie-chart.min.js"></script>

		<!-- SPARKLINES -->
		<script src="${cxt}/static/smart/js/plugin/sparkline/jquery.sparkline.min.js"></script>
		...
		<script src="${cxt}/static/smart/js/plugin/select2/select2.min.js"></script>

		<!-- JQUERY UI + Bootstrap Slider -->
		<script src="${cxt}/static/smart/js/plugin/bootstrap-slider/bootstrap-slider.min.js"></script>

		<!-- browser msie issue fix -->
		<script src="${cxt}/static/smart/js/plugin/msie-fix/jquery.mb.browser.min.js"></script>

		<!-- FastClick: For mobile devices: you can disable this in app.js -->
		<script src="${cxt}/static/smart/js/plugin/fastclick/fastclick.min.js"></script>
		...
		<!-- Demo purpose only -->
		<script src="${cxt}/static/smart/js/demo.min.js"></script>
		...
		<script src="${cxt}/static/smart/js/speech/voicecommand.min.js"></script>

		<!-- SmartChat UI : plugin -->
		<script src="${cxt}/static/smart/js/smart-chat-ui/smart.chat.ui.min.js"></script>
		<script src="${cxt}/static/smart/js/smart-chat-ui/smart.chat.manager.min.js"></script>
